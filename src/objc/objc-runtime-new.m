...
static void methodizeClass(struct class_t *cls)
{
    ...
    if (cats  ||  cls->data->ro->baseProtocols) {
        cls->data->protocols = 
            buildProtocolList(cats, (protocol_list_t*)cls->data->ro->baseProtocols, NULL);
    }
    ...
    */
    ...
    if (supercls) {
        ...
        if (ro->instanceStart < supercls->data->ro->instanceSize) {
            ...
            ro = rw->ro;
            moveIvars(ro_w, supercls->data->ro->instanceSize, NULL, NULL); 
...
void objc_setFutureClass(Class cls, const char *name)
{
    ...
    addFutureClass(name, (class_t *)cls);
